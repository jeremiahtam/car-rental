...
export const UserChangePassword = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 border border-gray-100 dark:border-gray-700">
      <h1 className="text-sm font-semibold leading-tight tracking-tight text-gray-900 md:text-sm dark:text-white">
        Change your password
      </h1>
      {changePasswordFeedback !== null && (
        <div className="text-sm text-red-600">{changePasswordFeedback}</div>
      )}
      <Formik
        initialValues={{
          password: "",
